...
export type WhatsAppAssistantAuditEvent =
  ...
  | 'WHATSAPP_REPLY_MODE_RESOLVED'
  | 'WHATSAPP_AUDIO_REPLY_START'
  | 'WHATSAPP_AUDIO_REPLY_SUCCESS'
  | 'WHATSAPP_AUDIO_REPLY_ERROR'
  | 'WHATSAPP_TTS_MODEL_ERROR'
  | 'WHATSAPP_TTS_EMPTY_AUDIO'
  | 'WHATSAPP_AUDIO_UPLOAD_START'
  | 'WHATSAPP_AUDIO_UPLOAD_SUCCESS'
  | 'WHATSAPP_AUDIO_UPLOAD_ERROR'
  | 'WHATSAPP_AUDIO_SEND_START'
  | 'WHATSAPP_AUDIO_SEND_SUCCESS'
  | 'WHATSAPP_AUDIO_SEND_ERROR'
  | 'WHATSAPP_REPLY_AUDIO_SENT'
  | 'WHATSAPP_REPLY_AUDIO_SKIPPED'
  | 'WHATSAPP_ORCHESTRATION_PASSTHROUGH_LEGACY'
